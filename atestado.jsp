            ...
            <main>
                <%@ include file="public/parts/sidebar.jsp" %>
                    <section class="content">
                        <h1>Emitir Atestado</h1>
                        <small class="content-subtitle">Preencha os campos a seguir para emitir atestado.</small>
                            <div class="content-prescription">
                                <form action="#" method="dialog">
                                    <div class="form-input-group">
                                        ...
                                        <div class="prescription-input">
                                            <label for="patientArrived">Horário de Chegada</label>
                                            <input type="time" id="patientArrived">
                                        </div>
                                        <div class="prescription-input">
                                            <label for="patientDeparture">Horário de Saída</label>
                                            <input type="time" id="patientDeparture">
                                        </div>
                                    </div>
                                    <button type="button" onclick="createSickNote()">
                                        Gerar Atestado
                                    </button>
                                </form>
                            </div>
