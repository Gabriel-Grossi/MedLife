<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Cadastrar Paciente | MedLife</title>
    </head>
        ...
        <%@ include file="public/parts/header.jsp" %>
                        ...
                        <div class="content-appointment">
                            <form action="" method="post">
                                <div class="form-input-group">
                                    ...
                                    <div class="appointment-input">
                                        <label for="patientEmailAddress">E-mail</label>
                                        <input type="email" name="patientEmailAddress" id="patientEmailAddress"
                                            placeholder="Insira o nome do paciente" required>
                                    </div>
                                    <div class="appointment-input">
                                    ...
                                    <div class="appointment-input">
                                        ...
                                        <input type="text" name="patientAddress" id="patientAddress" placeholder="Insira o logradouro" required>
                                    </div>
                                    <div class="appointment-input">
                                        <label for="patientAddressComplement">Complemento</label>
                                        <input type="text" name="patientAddressComplement" id="patientAddressComplement" placeholder="Insira o complemento"
                                            required>
                                    </div>
                                    <div class="appointment-input">
                                        <label for="patientAddressNumber">Número</label>
                                        <input type="number" name="patientAddressNumber"  id="patientAddressNumber" placeholder="Insira o número"
                                            required>
                                    </div>
                                    <div class="appointment-input">
                                        <label for="patientAddressCEP">CEP</label>
                                        <input type="text" name="patientAddressCEP" id="patientAddressCEP" placeholder="Insira o CEP" maxlength="9"
                                            required>
                                    </div>
                                    <div class="appointment-input">
                                    ...
                                    <div class="appointment-input">
                                        ...
                                        <input type="text" name="patientAddressCity" id="patientAddressCity" maxlength="40" placeholder="Insira a cidade" required>
                                    </div>
                                    <div class="appointment-input">
                                    ...
                                    <div class="appointment-input">
                                        ...
                                        <input list="medicalInsurance" type="text" name="patientMedicalInsurance"
                                            id="patientMedicalInsurance" placeholder="Escolha o Convênio Médico" required>
            ...
            <div id="modal-wrapper">
                <div class="modal">
                    ...
                    <h2 id="scheduled-appointment">Consulta Agendada</h2>
            ...
            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.16/jquery.mask.min.js"
                ...
                crossorigin="anonymous" referrerpolicy="no-referrer"></script>
                <script src="public/scripts/uf.min.js"></script>
