...
<html>
    ...
    <body>
        ...
        try{
            ...
            String query = "UPDATE Appointment SET nome='"+nome+"' and data ='"+consulta+"' and medic='"+doctor+"' WHERE nome ='"+nome+"' and data='"+consulta+"' and hora ='"+consHour+"' and medic = '"+doctor+"')";
            ...
            con.close();
            response.sendRedirect("reagendarconsulta.jsp");
        }
